  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-slate-100 px-4 py-8 flex items-center justify-center">
      <div className="w-full max-w-5xl">
        <div className="mb-8 rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/20 backdrop-blur-xl">
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <h1 className="text-4xl font-semibold tracking-tight">Hand Sign Detector</h1>
              <p className="mt-3 max-w-2xl text-slate-300">A sleek live hand-sign tracker with real-time overlay and match feedback. Use your camera to detect hand poses and compare against the target gesture.</p>
            </div>
